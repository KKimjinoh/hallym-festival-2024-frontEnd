      ...
      <div className="pubInfo-container">
        <div className="pubInfo-container-wrapper">
          ...
          <div className="contents">
            ...
            <ul>
              <li>
                밤부스 운영시간 : 18:00 ~ 02:00<br></br>예약자 입장 시간 : 17:00 ~ 17:30
              </li>
              <li>200 테이블 수용</li>
            ...
            <ul>
              <li>
                ...
                <br />
                (수업 시간을 고려한 시간대이며 다소 이른 시간이라도 양해 부탁드립니다)
              </li>
              <li>인당 1 테이블 예약 가능</li>
              <li>1 테이블 예약 시, 최대 4명까지 함께 예약 가능 (ex-의자 4개, 테이블 1개)</li>
              <li>대표자(예약자) 입장 필수!</li>
              <li>
                - 예약자 기준 야간주점 측에서 문자 발송 진행(입장 시 STAFF에게 보여준 후 입장)
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>예약자 입장시간 : 17:00 ~ 17:30 (이 시간 내에 미방문 시 예약 취소)</li>
            </ul>

            <h1 className="title">밤부스 프로그램 부스 (ECO팝)</h1>
            <ul>
              <li>장소 : 지혜의길 (메인통제부스)</li>
              <li>방법 : 일정량의 쓰레기를 기준량보다 많이 모아오면 중앙통제부스에서 팝콘 배부</li>
              <p>진행시간</p>
              <li>20:00 ~ 21:00</li>
              <li>21:30 ~ 22:30</li>
              <li>23:00 ~ 24:00</li>
